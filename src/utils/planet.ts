...
export const PlanetSchema = z.object({
  ...
  overview: z.object({ content: z.string(), source: z.string() }),
  structure: z.object({ content: z.string(), source: z.string() }),
  geology: z.object({ content: z.string(), source: z.string() }),
  rotation: z.string(),
  revolution: z.string(),
  radius: z.string(),
